...
from gopad import rest
from gopad.configuration import Configuration
from gopad.exceptions import ApiTypeError, ApiValueError, ApiException
from gopad.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'gopad-python/1.0.0-alpha1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.login_user  # this is an instance of the class Endpoint
        api_instance.login_user()  # this invokes api_instance.login_user.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.login_user.callable or self.callable in this class
